...
local jdtls_config = jdtls_root .. '/config_win'
local equinox_launcher = jdtls_root .. '/plugins/org.eclipse.equinox.launcher_1.6.800.v20240330-1250.jar'
